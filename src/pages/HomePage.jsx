    ...
    >
      <section className="hero-section">
        ...
        <div className="hero-text">
          ...
          <h1>
            Klasifikasi <span className="highlight">Diabetes</span> <br />
            Berbasis <span className="highlight">Machine Learning</span>
          </h1>
          <p>
            ...
            hasil klasifikasi dalam hitungan detik.
          </p>
          <button
            className="cta-btn modern"
            onClick={() => navigate("/predict")}
          >
            <span>🚀</span> Mulai Klasifikasi
          </button>
        </div>
        ...
        <div className="features-list">
          <div className="feature-item">
            ...
            <div className="feature-desc">
              Model machine learning terlatih dengan data valid untuk hasil
              klasifikasi yang presisi.
            </div>
          </div>
          <div className="feature-item">
            <div className="feature-icon">
            ...
            <div className="feature-title">Klasifikasi Instan</div>
            <div className="feature-desc">
              Hasil klasifikasi langsung muncul tanpa menunggu lama, cukup
              beberapa detik.
            </div>
          </div>
          <div className="feature-item">
            ...
            <div className="feature-desc">
              Bisa diakses dari perangkat apapun, kapan saja, tanpa instalasi
              tambahan.
            </div>
          </div>
        </div>
      ...
      <section className="about-diabetes-section">
        ...
        <div className="about-diabetes-text">
          ...
          <p>
            Diabetes adalah penyakit kronis yang memengaruhi cara tubuh
            memproses gula darah (glukosa). Deteksi dini dan pengelolaan yang
            tepat sangat penting untuk mencegah komplikasi serius.
          </p>
        </div>
        <span className="about-diabetes-accent">
          ...
          >
            <path
              d="M0 40 Q150 80 300 40 T600 40"
              stroke="#4f8cff33"
              strokeWidth="8"
              fill="none"
            />
      ...
      <section className="how-it-works-section">
        ...
        <h2>Bagaimana Cara Kerja Klasifikasi?</h2>
        <div className="steps-list">
          ...
          <div className="step-card">
            ...
            <h3>3. Hasil Klasifikasi</h3>
            <p>Hasil klasifikasi risiko diabetes langsung muncul untuk Anda.</p>
          </div>
        </div>
      </section>
      {/* Kontak Section */}
