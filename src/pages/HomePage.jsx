...
function HomePage() {
  ...
  return (
    ...
    >
      ...
      {/* Kontak Section */}
      <section className="contact-main" id="contact-section" style={{ marginTop: "2rem" }}>
      ...
      <section className="about-diabetes-section">
        <div className="about-diabetes-img">
          <img src="https://images.unsplash.com/photo-1505751172876-fa1923c5c528?auto=format&fit=crop&w=600&q=80" alt="Ilustrasi Diabetes" />
        </div>
      ...
      <section className="how-it-works-section">
        ...
        <div className="steps-list">
          <div className="step-card">
            <img src="https://images.unsplash.com/photo-1512070679279-c2f999098c01?auto=format&fit=crop&w=400&q=80" alt="Isi Data" />
            <h3>1. Isi Data Kesehatan</h3>
            <p>Masukkan data kesehatan Anda secara singkat dan mudah.</p>
          </div>
          <div className="step-card">
            <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80" alt="Proses AI" />
            <h3>2. Proses AI</h3>
            <p>Data Anda diproses oleh sistem Machine Learning canggih.</p>
          </div>
          <div className="step-card">
            <img src="https://images.unsplash.com/photo-1514412076812-cd4c2b6a3b10?auto=format&fit=crop&w=400&q=80" alt="Hasil Prediksi" />
